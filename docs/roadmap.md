...
| **Roadmap-Rumpf trägt Entstehungsgeschichte — die zweite Hälfte der Zeitform-Regel.** Welle 71 hat die Klasse *Zustands-Artefakt trägt Entstehungsgeschichte* für Kommentare bestimmt ([`harness-dateien.md` §Was ein Kommentar trägt](../kurs/de/grundlagen/harness-dateien.md#was-ein-kommentar-trägt--code-konfiguration-skripte): fünf Klassen, Adressaten- und Zeitform-Test); ihre Roadmap-/Register-Hälfte ist unbestimmt, und diese Datei zeigt sie — gemessen 2026-08-22: (1) die `Stand`-Zellen der offenen Fäden sind Chroniken statt Zustände, 894, 1.174 und 1.303 Zeichen in drei Zeilen; (2) §Historische Trigger-Verschiebungen sagt *Noch keine.* und trägt darunter 18 Zeilen — neun Meilensteine, neun Faden-Schließungen, keine einzige Trigger-Verschiebung —, während §Abgeschlossene Wellen Nicht-Duplikation zusagt und [Modul 6 Schritt 6](../kurs/de/02-planung/modul-06-roadmap.md#worked-example-einen-datumswunsch-in-eine-trigger-welle-übersetzen) das Drift-Log als Bewegungs-Anhang (Datum · Was · Warum) und das Closure-Log für Wellen definiert; (3) zwei stehengebliebene Zustandssätze (`Stand: 2026-07-31`, „Der letzte war v5.6.0"). **Handlung:** Norm zuerst in der Quelle — was eine `Stand`-Zelle trägt (Zustand + Zeiger auf den Beleg, keine Chronik), wohin eine Faden-Schließung gehört (CHANGELOG als Closure-Log, die Roadmap behält den Vorwärts-Blick), was das Drift-Log trägt (nur Trigger-Verschiebungen — heute null, und das ist zu benennen, nicht zu füllen) und wo Meilensteine/Releases stehen; dann Regelwerk und Template, zuletzt diese Datei umbauen | der nächste Meilenstein-Eintrag oder die nächste Faden-Schließung in dieser Datei — das `v5.8.0`-Release steht an | offen seit Welle 82; **diese Datei ist umgebaut** (2026-08-22: `Stand` = Zustand + Anker, Drift-Log nur Umplanungen, erreichte Meilensteine unter §Meilensteine, geschlossene Fäden raus) — die Norm in der Quelle steht aus: Quelle → Regelwerk → Template |
...
|---|---|---|---|
| `v5.8.0` | 82 | Release-Trigger oben | offen |
