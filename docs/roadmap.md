...
| **`beobachtet`-Spalte des Team-Sim ist nicht reproduzierbar** — `verdikt()` protokolliert `$(echo "$out"|tail -1)`; d-check legt Summen- und Befundzeilen nicht in fester Reihenfolge ab, also greift `tail -1` mal die eine, mal die andere. Zwei identische Volläufe unterscheiden sich in 11 von 63 `beobachtet`-Zellen (s04b, s04f, s04i, s04g, s08a, s15b, s15c, s16c, s19e, s19j, s21b). Die **Verdikte** sind davon unberührt — sie prüfen Ziel und Code, nicht die Protokollzeile —, aber `README.md` nennt `ergebnis.tsv` „belegbar", und zwei Läufe mit verschiedenem Beleg unterlaufen das. **Handlung:** die Summenzeile gezielt greifen (`grep -E 'Datei\(en\) geprüft'`) statt `tail -1`, oder die Spalte auf die Befundzeile festlegen, die das Verdikt geprüft hat | *nicht gesetzt* — Entscheidung, kein Ereignis | offen seit Welle 129; im Review dieser Welle gemessen (diff zweier `ergebnis.tsv` desselben Stands) |
| **Der Block *Offene Wellen* kostet, ohne zu tragen** — er ist in [Modul 6](../kurs/de/02-planung/modul-06-roadmap.md) als **derivativ** deklariert (*„der Zustand sind die flachen Welle-Dateien"*) und wird von Hand geführt. Gemessen (`lab/team-sim` s24e): Zwei Schreiber, die verschiedene Wellen in eigenen Zweigen eröffnen, kollidieren auf der Liste — auf den Welle-Dateien **nicht**. Ohne die Liste mergen zwei Wellen sauber, und es wird nichts still: Die Namen sind verschieden, der stille Fall wäre eine doppelte *Nummer*, und die hängt an der Vergabe, nicht an der Liste. **Die Bewertung *niedrig — laut* in [`team.md`](team.md) trägt hier nicht**: Sie misst die Schwere pro Ereignis für einen Menschen (zwei Zeilen, beide bleiben). Für einen Agenten ist derselbe Konflikt ein Halt mit Eskalation — bei N Agenten warten N−1. **Handlung:** prüfen, ob der Block entfallen kann und `planning.waves` die Bijektion gegen das Verzeichnis statt gegen die Liste hält; zugleich die Risiko-Skala in `team.md` um die Achse *wer kann auflösen* ergänzen | **ein Repo lässt Schreiber ohne Urteilsvollmacht nebenläufig Wellen eröffnen** | offen seit Welle 130; Konflikt gemessen, Auflösung nicht entworfen |
...
| `v6.8.0` | 135 | erfüllt | erreicht 2026-09-13 (Lauf 34736141296) |
| `v6.7.2` | 134 | erfüllt | erreicht 2026-09-12 (Lauf 34703505867) |
| `v6.7.1` | 133 | erfüllt | erreicht 2026-09-12 (Lauf 34673938325) |
| `v6.7.0` | 130, 131, 132 | erfüllt | erreicht 2026-09-11 (Lauf 34621764934) |
| `v6.6.0` | 129 | erfüllt | erreicht 2026-09-08 (Lauf 34217058901) |
| `v6.5.0` | 125, 127, 128 | erfüllt | erreicht 2026-09-06 (Lauf 34048857068) |
| `v6.4.0` | 124 | erfüllt | erreicht 2026-09-06 (Lauf 34042907001) |
| `v6.3.1` | 123 | erfüllt | erreicht 2026-09-06 (Lauf 34021495542) |
| `v6.3.0` | 120 | erfüllt | erreicht 2026-09-06 (Lauf 34021235646) |
| `v6.2.0` | 119 | erfüllt | erreicht 2026-09-05 (Lauf 33984886412) |
| `v6.1.0` | 118 | erfüllt | erreicht 2026-09-05 (Lauf 33978363291) |
| `v6.0.0` | 116 | erfüllt | erreicht 2026-09-03 (Lauf 33789834564) |
| `v5.20.0` | 114 | erfüllt | erreicht 2026-09-03 (Lauf 33785127033) |
| `v5.19.0` | 112–113 | erfüllt | erreicht 2026-09-03 (Lauf 33783670733) |
| `v5.18.0` | 111 | erfüllt | erreicht 2026-08-31 (Lauf 33427715551) |
