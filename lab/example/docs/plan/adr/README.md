...
- Das `**Schärft:**`-Feld wurde am 2026-06-10 als Konventions-Backfill in die damals fünf Accepted-ADRs ergänzt: Traceability-Metadata, keine Entscheidungs-Änderung — Immutability schützt die *Entscheidung*, nicht die Nachpflege (wie die Geschichte-/Index-Tabellen).
