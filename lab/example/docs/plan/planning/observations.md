...
|---|---|---|---|
| BEO-006 | `check-references` prüft nur `spec/`, nicht `docs/plan/adr/` | 2026-06-14 | Ursache beseitigt: `slice-022` löst den Skript-Sensor durch d-check `matrix` ab, das `adr` als Quellklasse führt — die Lücke kann nicht wieder entstehen |
