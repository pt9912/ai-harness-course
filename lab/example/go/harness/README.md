...
- `go/.a-check.yml` — Layering-Gate, deklarativer Sensor ([ADR-0001](../../docs/plan/adr/0001-hexagonale-architektur.md), Werkzeugwahl [ADR-0018](../../docs/plan/adr/0018-grenzen-gehoeren-in-die-konfiguration.md)).
