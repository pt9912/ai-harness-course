...
// misst dann NUR den kritischen Layer (service) gegen 90 %; index ist bis
// Welle 2 ausgenommen. Analog go (./internal/service/... 90), python
// (src/docsearch/service 90) und cpp (gcovr auf src/hexagon/service/).
