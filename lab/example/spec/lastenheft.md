...
> Anforderungen mit *Bereichskürzel* (`LH-FA-<BEREICH>-<NNN>`) — die Form, die
> [Kurs §Vergabe](../../../kurs/de/grundlagen/source-precedence.md#vergabe-woher-die-nächste-kennung-kommt)
> für den Zählraum je Sub-Area vorsieht. Sie entspricht der Stratifizierung in
...
Dokument eine Vertragsänderung — auch das Hinzufügen einer neuen Anforderung —
und entsteht nur aus einem Change Request. Einzige Ausnahme ist die
Tatsachenberichtigung, hier als solche ausgewiesen (`0.4.1`). DocSearch ist sein
