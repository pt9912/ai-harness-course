...
**Ersetzt-Baseline-Regel:** [`konventionen.md` §Sensors — die vier kanonischen Bindung-Klassen als abschließende Liste](../../../../kurs/de/grundlagen/konventionen.md#harnessreadmemd-als-einstiegspunkt)
