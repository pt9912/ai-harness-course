...
namespace DocSearch.Tests
{
    public class ArchitectureTests
    {
        ...
        {
            TestResult result = NetArchTest.Rules.Types.InAssembly(typeof(UI.Handler).Assembly)
        ...
        {
            TestResult result = NetArchTest.Rules.Types.InAssembly(typeof(Service.Searcher).Assembly)
        ...
        {
            TestResult result = NetArchTest.Rules.Types.InAssembly(typeof(Index.VectorIndex).Assembly)
        ...
        {
            TestResult result = NetArchTest.Rules.Types.InAssembly(typeof(Embedding.IEmbedder).Assembly)
