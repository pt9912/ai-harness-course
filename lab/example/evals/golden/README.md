...
| Set | Beschreibung |
|---|---|
| [`welle-mvp-baseline/`](welle-mvp-baseline/) | Baseline nach Welle-1-Abschluss: Happy + Boundary + Negative für [LH-FA-02](../../spec/lastenheft.md#lh-fa-02--semantische-suche) — `manifest.yaml` + `inputs/case-{001,002,003}.json` + `expectations/case-{001,002,003}.json` + `CHANGELOG.md` |
...
jedem Case-Edit anwächst. Migration siehe `welle-mvp-baseline/CHANGELOG.md`.
