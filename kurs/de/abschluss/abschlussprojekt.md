...
* Harness-Bootstrap-Klassifikation pro Sub-Area (GF/BF/Hybrid-Modus,
  ...
  passender Granularität wählen (Inklusionskriterium: [`../grundlagen/konventionen.md` §Was ist eine Sub-Area?](../grundlagen/bootstrap.md#was-ist-eine-sub-area), drei Achsen, Schwelle ≥ 2 — *"Backend"* ist zu grob)
* Spezifikation
* ADRs
* Planning Lifecycle
* Agentenrollen
