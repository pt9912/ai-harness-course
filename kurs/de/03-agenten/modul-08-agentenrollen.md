...
Slice-Plan slice-audit-log-hardening."*
...
sequenceDiagram
    ...
    I->>A: Widerspruch + Verweis auf slice-audit-log-hardening
    A->>P: ADR-0001-Aktualität prüfen, slice-audit-log-hardening vorlegen
    P-->>A: Slice-Plan slice-audit-log-hardening (Lockerung erwähnt?)
    A-->>R: Verdikt (ADR gilt / Folge-ADR / slice-audit-log-hardening falsch)
...
| A → R | Verdikt | ADR-Stand bestätigt / Folge-ADR-Hülle / slice-audit-log-hardening-Korrektur |
...
|---|---|---|
| ADR-0001 gilt unverändert, slice-audit-log-hardening hat falsch behauptet | A → P: Slice-Plan-Korrektur; P → I: aktualisierter Plan; I implementiert ADR-konform neu | Plan-Diff mit Korrektur-Begründung |
