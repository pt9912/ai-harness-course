...
bzw. [`bootstrap.md` §Harness-Bootstrap](../grundlagen/bootstrap.md#harness-bootstrap);
...
und [`traceability.md` §Herkunfts-Anker](../grundlagen/traceability.md#herkunfts-anker-für-steering-loop-regeln).
...
in [`bootstrap.md` §Harness-Bootstrap](../grundlagen/bootstrap.md#harness-bootstrap)
...
[`source-precedence.md#source-precedence`](../grundlagen/source-precedence.md#source-precedence)).
...
* Source Precedence im Detail: [`source-precedence.md#source-precedence`](../grundlagen/source-precedence.md#source-precedence)
