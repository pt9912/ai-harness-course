...
**Kein Kopf-Datum, kein Kopf-Status.** Die Spezifikation trägt ihre Änderungen
in der Historie — die letzte Zeile ist das Datum; ein Frische-Marker im Kopf
(`Letzte Änderung`) wäre dasselbe Datum ein zweites Mal, und zwei Felder für
eines driften. Das unterscheidet sie von der Sicht, die keine Historie hat
