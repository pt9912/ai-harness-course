...
| [`agents-regelwerk.md`](agents-regelwerk.md) | Der Kurs als Betriebsregelwerk **für Code-Agenten**: didaktik-freier Extrakt (Regeln, Konventionen, Abläufe in Quellformulierung — weggelassen ist die Didaktik-Schicht, nicht verdichtet der Inhalt). Derivativ — bei Konflikt gilt die Quelle. Für Menschen kein Ersatz für die Module. |
