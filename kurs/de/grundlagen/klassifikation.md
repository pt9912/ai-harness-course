...
* *Inferential + Feedforward*: gibt dem Agenten Kontext, **bevor** er handelt. Das sind Spec, ADR, Carveouts — die Hebel aus [Modul 3](../01-spec-und-architektur/modul-03-spec.md), [Modul 4](../01-spec-und-architektur/modul-04-adrs.md), [Modul 7](../02-planung/modul-07-carveouts.md).
