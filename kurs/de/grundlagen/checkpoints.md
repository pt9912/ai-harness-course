...
2. Schreibe drei Slice-Dateien, jede mit einem eigenen beschreibenden Namen
   (z. B. `slice-suche`, `slice-filter`, `slice-export`), DoD und Trigger für
   den Übergang in `done/`.
