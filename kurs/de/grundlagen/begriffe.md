...
| ID-Schema | Stabile Präfix-Klammer (`LH-*`, `HSM-*`, `GG-*`), die Spec-Anforderungen, Make-Target-Kommentare, ADRs und Commits verbindet. Das Präfix kodiert zugleich das Stratum. Siehe [§ID-Schema](source-precedence.md#id-schema-als-klammer). |
