...
zum Stabileren. Die [§Spec-Stratifizierung](source-precedence.md#spec-stratifizierung)
...
([§Spec-Stratifizierung](source-precedence.md#spec-stratifizierung), [§Source Precedence](source-precedence.md#source-precedence))
...
- **ADR → Spec-§**: die ADR *deklariert, was sie schärft* (Acceptance-
  Trigger, [§Vier Trigger-Klassen](bootstrap.md#vier-trigger-klassen)). **Hier wohnt
