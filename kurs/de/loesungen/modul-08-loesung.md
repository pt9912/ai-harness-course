...
| **eskaliert** | weder ADR-Stand noch Lockerung sind belegbar (z. B. slice-audit-log-hardening behauptet etwas, das nirgends dokumentiert ist) | ADR-Aktualitäts-Anfrage an den Planner: Slice-Plan-Auszug vorlegen; danach fällt der Fall in eines der ersten beiden Verdikte |
...
- Spec/ADR/Plan-Trennung: [`begriffe.md#trennschärfen`](../grundlagen/begriffe.md#trennschärfen)
