...
| Restrisiken handlungsorientiert | ja — Refresh-Token-Flow offen, Folge-Slice slice-authentifizierung-b vorgeschlagen, Audit-Rotation als DoD-Hinweis | nein — "minimal" ist ein Urteil ohne Gegenstand |
